...
module reg_file #(parameter DATA_WIDTH = 32) (
	...
	input       forward,
    input       wr_en,
	input       [DATA_WIDTH-1:0] ALU_data_forward, 
    input       [4:0] rd_addr1, rd_addr2, wr_addr,destination1,destination2,
...
always @(posedge clk) begin
     if (forward == 1'b0 ) reg_file_arr[destination1]<= ALU_data_forward; 
     if (forward == 1'b1 ) reg_file_arr[destination2]<= ALU_data_forward; 
